        ...
        <Route path="/" element={
          ...
          <main className="home">
            ...
            <section className="banner">
              ...
              <div ref={(el) => slideTopRefs.current.push(el)} className="logoXL">
                <Link to="/">
            ...
            <section className="intro">
              <div id="intro1">
                <div className='door'>
                  <figure> <img src="/images/door.png" ref={(el) => slideRightRefs.current.push(el)} alt="未知之門" /></figure>
                  <div id="intro_Q" ref={(el) => slideLeftRefs.current.push(el)} >
              ...
              <div id="intro2">
                <div className="title" ref={(el) => slideTopRefs.current.push(el)}>
                ...
                <Intro2Component />
                <div ref={(el) => slideTopRefs.current.push(el)}><Carousel /></div>
              </div>
              <div id="intro3">
                <div className="title" ref={(el) => slideTopRefs.current.push(el)}>
                ...
                <div className="map-area">
                  <img src="/images/map_intro.jpg"  ref={(el) => slideRightRefs.current.push(el)}alt="Map Intro" />
            ...
            <footer>
              <div className="content">
                ...
                <div className="left">
                  <ul className="link">
                    <li><Link to="/Story">怪奇博物館</Link></li>
                    <li><Link to="/Map">靈異導航</Link></li>
                    <li><Link to="/Forum">鬼影探索</Link></li>
